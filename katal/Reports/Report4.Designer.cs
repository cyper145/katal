...
namespace katal.Reports
{
    partial class Report4
    {
        ...
        private void InitializeComponent()
        {
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[CNUMERO]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[ANEX_CODIGO]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[ANEX_DESCRIPCION]")});
            ...
            // objectDataSource1
            // 
            parameter1.Name = "codEmpresa";
            parameter1.Type = typeof(DevExpress.DataAccess.Expression);
            parameter1.Value = new DevExpress.DataAccess.Expression("", typeof(string));
            objectConstructorInfo1.Parameters.AddRange(new DevExpress.DataAccess.ObjectBinding.Parameter[] {
            parameter1});
            this.objectDataSource1.Constructor = objectConstructorInfo1;
            this.objectDataSource1.DataMember = "findAll";
            this.objectDataSource1.DataSource = typeof(katal.conexion.model.dao.ComprobanteDao);
