...
namespace katal.conexion.model.entity
{
    public class Proveedor
    {
        ...
        public string PRVDFECCRE { get; set; }
        ...
        public string PRVDFECMOD { get; set; }
        ...
        public string PRVNCOMERCIAL { get; set; }
        public string PRVNOMBRES { get; set; }
        public string PRVAPELPATERNO { get; set; }
        public string PRVAPELMATERNO { get; set; }
